...
To install a previous version of proto

### Linux, macOS, WSL

In a terminal that supports Bash, run:

Example using [v0.19.3](https://github.com/moonrepo/proto/releases/tag/v0.19.3)
```shell
curl -fsSL https://moonrepo.dev/install/proto.sh | bash -s -- 0.19.3
```
